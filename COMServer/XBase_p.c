...
/* Object interface: IConnection, ver. 0.0,
   GUID={0xFE5E78F1,0x88CE,0x4E02,{0x89,0xED,0xE1,0x39,0x39,0xB7,0xCB,0x42}} */
...
const CInterfaceProxyVtbl * _XBase_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IConnectionProxyVtbl,
    0
};

const CInterfaceStubVtbl * _XBase_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IConnectionStubVtbl,
    0
};

PCInterfaceName const _XBase_InterfaceNamesList[] = 
{
    "IConnection",
    0
};

const IID *  _XBase_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _XBase_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _XBase, pIID, n)

int __stdcall _XBase_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_XBase_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo XBase_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _XBase_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _XBase_StubVtblList,
    (const PCInterfaceName * ) & _XBase_InterfaceNamesList,
    (const IID ** ) & _XBase_BaseIIDList,
    & _XBase_IID_Lookup, 
    1,
    2,
